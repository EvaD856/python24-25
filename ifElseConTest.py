...
number = int(input("Enter the students numberic grade: "))
#if number > 100:
  #  print("Error: grade must be between 100 and 0")
#elif number < 0:
   # print("Error: grade must be between 100 and 0")

if number > 100 or number < 0: ### Coumpound Conditional
    #if number < 0 or number > 100
    print("Error: grade must be between 100 and 0") 

else: 
    # Code to convert numberic grade to Letter grade goes here
