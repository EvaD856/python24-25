...
#Complete the code to define a function that calculates the area of a circle. The funciton should take radius as an argument and return the area using the formula pi * radius^2. Assume that pi =3.14
