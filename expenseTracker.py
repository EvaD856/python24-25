...
Decription: This program allows users to add expenses with categories, view the total expenses, and see a summary of expenses by category.  It uses functions with multiple steps, internal calculations, and return values.
...
def add_expenses(expenses, category, amount):
    ...
    Args:
        ...
        category (str): The c ategory of the expense
